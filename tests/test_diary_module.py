...
class DiariesTest(unittest.TestCase):
    def test_get_entries(self):
        exp = {0: {'entry_id': 1, 'book_id': 1, 'overall_rating': 5, 'character_rating': 3, 'plot_rating': 2, 'summary': 'Summary', 'thoughts': '<p>Thoughts</p>', 'date_added': '11-02-2024', 'pages_read': 10, 'cover_image': '', 'title': 'Book 1', 'author_id': 1, 'author_name': 'Author 1', 'average_rating': 3.5, 'number_ratings': 2}, 1: {'entry_id': 2, 'book_id': 1, 'overall_rating': 1, 'character_rating': 2, 'plot_rating': 5, 'summary': 'Entry summary', 'thoughts': '<p>Entry thoughts</p>', 'date_added': '11-02-2024', 'pages_read': 21, 'cover_image': '', 'title': 'Book 1', 'author_id': 1, 'author_name': 'Author 1', 'average_rating': 3.5, 'number_ratings': 2}, 2: {'entry_id': 3, 'book_id': 2, 'overall_rating': 5, 'character_rating': 3, 'plot_rating': 2, 'summary': 'A summary', 'thoughts': '<p>Thoughts</p>', 'date_added': '11-02-2024', 'pages_read': 11, 'cover_image': '', 'title': 'Book 2', 'author_id': 2, 'author_name': 'Author 2', 'average_rating': 4.0, 'number_ratings': 3}}
        assert (diaries.get_entries(1) == exp)

        exp = {0: {'entry_id': 4, 'book_id': 5, 'overall_rating': 2, 'character_rating': 4, 'plot_rating': 1, 'summary': 'Entry summary', 'thoughts': '<p>Entry thoughts</p>', 'date_added': '11-02-2024', 'pages_read': 2, 'cover_image': '', 'title': 'Book 5', 'author_id': 1, 'author_name': 'Author 1', 'average_rating': 1.0, 'number_ratings': 1}, 1: {'entry_id': 5, 'book_id': 4, 'overall_rating': 4, 'character_rating': 5, 'plot_rating': 3, 'summary': 'Short entry summary', 'thoughts': '<p>Long entry thoughts.</p>', 'date_added': '11-02-2024', 'pages_read': 5, 'cover_image': '', 'title': 'Book 4', 'author_id': 2, 'author_name': 'Author 2', 'average_rating': 2.75, 'number_ratings': 4}}
